...
class AppUpdateService {
    ...
    try {
      ...
      if (isUpdateAvailable) {
        ...
        return {
          ...
          latestVersion,
          currentVersion,
          downloadUrl: (this.latestVersionInfo && this.latestVersionInfo.downloadUrl) || this.GITHUB_DOWNLOAD_URL,
          releaseNotes: (this.latestVersionInfo && this.latestVersionInfo.releaseNotes) || 'Nouvelle version disponible'
        };
      } else {
        // Application à jour
  ...
  async downloadAndInstallUpdate(updateInfo) {
    try {
      ...
      const releaseNotes = (this.latestVersionInfo && this.latestVersionInfo.releaseNotes) || '';
