  ...
  addScans: async (scansArray) => {
    ...
    try {
      ...
      const formattedScans = scansArray.map(scan => ({
        ...
        tournee: scan.tournee || (sessionData && sessionData.tournee && sessionData.tournee.nom) || '',
        tournee_id: scan.tourneeId || (sessionData && sessionData.tournee_id) || '',
        vehicule: scan.vehicule || (sessionData && sessionData.vehicule && sessionData.vehicule.immatriculation) || '',
